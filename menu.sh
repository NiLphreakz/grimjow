...
echo -e "  \e[$number (4)\e[m \e[$below UDP-CUSTOM MENU\e[m"     
echo -e " \e[$line╒════════════════════════════════════════════════════════════╕\e[m"
...
echo -e "  \e[$number (6)\e[m \e[$below CHECK RUNNING\e[m        \e[$number (10)\e[m \e[$below REBOOT VPS\e[m"
echo -e "  \e[$number (7)\e[m \e[$below CHANGE PORT\e[m          \e[$number (11)\e[m \e[$below CLEAR EXPIRED FILES\e[m"
echo -e "  \e[$number (8)\e[m \e[$below INFO ALL PORT\e[m        \e[$number (12)\e[m \e[$below CLEAR LOG VPS\e[m"  
echo -e ""
