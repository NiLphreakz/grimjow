...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/NiLphreakz/grimjow/main/acme.sh -o /root/.acme.sh/acme.sh
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/grimjow/main/cert.sh"
